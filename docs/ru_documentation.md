...
В текущей версии бота v0.9.5 запросы могут быть только тектовыми, так как сама языковая модель deepseek, к которой отправляют запросы является текстовой. Данная языковая модель не может обрабатывать документы или какие-либо изображения, поэтому сам бот не отвечает на такие запросы. То же самое применимо и к голосовым сообщениям с кружочками.
...
Политика конфиденциальности обязательна к ознакомлению. Пользователь автоматически соглашается с ней, при использовании бота. [Подробнее]()

### Дисклеймер | Политика использования

Политика использования и дисклеймер обязательны к ознакомлению. Пользователь автоматически соглашается с этой политикой при использовании бота. [Подрбнее]()
